...
The wanted operation to be performed is selected by the user, allowing the ALU to operate in different modes while maintaining a simple and deterministic structure.
