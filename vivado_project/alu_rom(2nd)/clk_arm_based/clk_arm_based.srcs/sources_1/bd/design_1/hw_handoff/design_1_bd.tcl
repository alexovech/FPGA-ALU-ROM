...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Const_0 [ create_bd_port -dir I -from 3 -to 0 Const_0 ]
  set Opcode_0 [ create_bd_port -dir I -from 1 -to 0 Opcode_0 ]
  set Result_0 [ create_bd_port -dir O -from 7 -to 0 Result_0 ]
  ...
  # Create instance: alu_block_0, and set properties
  set block_name alu_block
  set block_cell_name alu_block_0
  if { [catch {set alu_block_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $alu_block_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net Const_0_1 [get_bd_ports Const_0] [get_bd_pins alu_block_0/Const]
  connect_bd_net -net Opcode_0_1 [get_bd_ports Opcode_0] [get_bd_pins alu_block_0/Opcode]
  connect_bd_net -net ROM_0_DAT [get_bd_pins ROM_0/DAT] [get_bd_pins alu_block_0/ROM_inp]
  connect_bd_net -net alu_block_0_Result [get_bd_ports Result_0] [get_bd_pins alu_block_0/Result]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_0/Q] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins ROM_0/ADR] [get_bd_pins xlslice_0/Dout]
