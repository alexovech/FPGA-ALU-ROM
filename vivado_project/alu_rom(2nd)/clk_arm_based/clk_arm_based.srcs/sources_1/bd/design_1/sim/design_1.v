...
module design_1
  ...
  assign Const_0_1 = Const_0[3:0];
  assign Opcode_0_1 = Opcode_0[1:0];
  assign Result_0[7:0] = alu_block_0_Result;
  design_1_ROM_0_0 ROM_0
       (.ADR(xlslice_0_Dout),
        .DAT(ROM_0_DAT));
  design_1_alu_block_0_0 alu_block_0
       (.Const(Const_0_1),
        .Opcode(Opcode_0_1),
        .ROM_inp(ROM_0_DAT),
        .Result(alu_block_0_Result));
